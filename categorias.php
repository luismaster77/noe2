...
<body>
    ...
    <div class="contenedorOfertasEspeciales">
        <div class="row">
            ...
            $productos;
            //Miramos que tipo de dato tenemos
            if (isset($_GET['marca'])) {
                //Probar
                // echo "Si hay marca: ";

                $marca_buscar = $_GET['marca'];

                //Probar
                echo $marca_buscar;

                if ($marca_buscar === null || $marca_buscar === '') {
                    $productos = obetenerTodos();
                } else {
                    // echo "<pre>";
                    // echo "entre a el else";
                    // echo "</pre>";
                
                    //$productos = obtenerProductosMarca($id_marca);
                    $productos = obtenerProductosMarca($marca_buscar);
                }
            } else {
                //Probar
                echo "no hay marca ";
                ...
                <div class="col-4 buscable">
                    ...
                    <div class="Costo">
                        ...
                        <?php if ($producto['descuento'] === '1') : ?>
                            <p class="Oferta"> <?php echo $producto['val_descuento']; ?>%off </p>
                            <p>$ <?php echo calcularPorcentaje($producto['precio'], $producto['val_descuento']); ?> </p>
