...
function obtenerId($marca = null) { //Revisar esta vaina

    include 'conexion.php';
    try {

        return $conn->query("SELECT id FROM marcas ");
...
function obtenerProductosMarca($id = null) {
    include 'conexion.php';
    try {

        return $conn->query("SELECT id, nombre, precio, imagen, descuento, val_descuento, id_marca FROM productos WHERE id_marca = {$id}");
...
function obetenerTodos() {
    include 'conexion.php';

    try {

        return $conn->query("SELECT id, nombre, precio, imagen, descuento, val_descuento, id_marca FROM productos");
