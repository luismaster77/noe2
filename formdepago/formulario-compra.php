            ...
            <form id="formulario" action="/action_page.php">
                <div class="row">
                    <div class="col-50">
                        ...
                        <div class="ocultado">
                        <label id="tipoP">
                            <input type="radio" checked="checked" name="tipoDePersona"> Persona Natural
                            <input type="radio" checked="checked" name="tipoDePersona"> Persona Juricica / Empresa
                        </label>
                        </div>
                        ...
                        <input type="text" name="documento" id="documento" placeholder="Tipo de documento">
                        </div>
                        <div class="ocultado">
...
<script src="Js/formulario-scripts13.js"></script>
<?php
