...
//header(" Location: http://www.calorstereofm.com.co/");
echo 'rediccionar'.$resultado;
//echo 'url zona pagos: '.die(json_decode($url));
//curl_exec($resultado['str_url']);
// $obj = json_decode($resultado);
// $url_exec = $obj->{'str_url'};
// $url_final =  strval($url_exec);
// echo "<SCRIPT>window.location='$url_final';</SCRIPT>";
//curl_exec("google.com");
var_dump($resultado);
// Se cierra el recurso CURL y se li…
